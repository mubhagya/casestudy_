package com.green.car.wash.washer.service;
...
public class WasherService {
    ...
    String url2="http://ORDER-SERVICE/orders";
    ...
    public List<OrderDetails> getUnassignedOrders(){
        OrderDetails[] unassignedList = restTemplate.getForObject(url2+"/findUnassigned",OrderDetails[].class);
    ...
    public OrderDetails updateStatus(OrderDetails orderDetails){
        ...
        OrderDetails od = restTemplate.exchange(url2+"/updateStatus", HttpMethod.PUT,updatedOrder,OrderDetails.class).getBody();
        return od;
    }
