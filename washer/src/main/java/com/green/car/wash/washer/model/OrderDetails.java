package com.green.car.wash.washer.model;
...
public class OrderDetails {
    ...
    public void setCars(Car cars) {
	  ...
	  orderId + '\'' + ", useremailid='" + useremailid + '\'' + ", washerName='" +
	  washerName + '\'' + ", washpack=" + washpack + ", phoneNo=" + phoneNo +
	  ", areapincode='" + areapincode + '\'' + ", status='" + status + '\'' +
	  ", cars=" + cars + '}'; }
